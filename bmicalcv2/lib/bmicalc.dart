        ...
        body: SingleChildScrollView(
          child: Column(children: [
            Container(
                height: 200,
                child: Center(
                  child: Image.asset('assets/images/BMIscaleNew.png'),
                )),
...
class _BmiFormState extends State<BmiForm> {
  ...
  Future loadOk() async {
    audioPlayer = await AudioCache().play("audios/ClickOn.wav");
  }

  Future loadFail() async {
    audioPlayer = await AudioCache().play("audios/ComputerError.wav");
  }
}
